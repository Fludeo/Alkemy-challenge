...
Para correr el proyecto simplemente hay que abrir 2 terminales (asegurarse de abrirlas en las respectivas carpetas), en una correr el cliente con "npm start" y en la otra correr el servidor con el script "npm run server"
